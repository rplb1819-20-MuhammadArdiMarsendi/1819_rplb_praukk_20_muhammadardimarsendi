  ...
  <div class="container-fluid">
	...
	<div class="container">
		<div class="row content">
			...
			<div class="col-md-6">
				<h3 class="signin-text mb-5" style="text-align: center;">Edit Rute</span></h3>
				...
				<form>
					...
					<div>
						<div class="form-group">
						<label for="username">TUJUAN</label>
					...
					<div>
						<div class="form-group">
						<label for="namapenumpang">RUTE AKHIR</label>
					...
					<div>
						<div class="form-group">
						<label for="id_level">ID TRANSPORTASI</label>
